...
==== 開発スピードの向上とコスト削減
ノーコードツールを導入する企業にとって、システムの内製化による開発スピードの向上とコスト削減が最大の価値ではないでしょうか。外注する場合、SIerの担当者に業務を説明し、実現したことを共有する必要がありますが、難易度も高く時間もかかります。結果的に意図した通りのシステムにならないという話もよく聞きます。一方ノーコードツールであれば、エンジニアでなくても、業務や自社の目指すところを理解している人が自分でシステムを作ることが可能になります。実際に、kintoneのお客様の中には、通常数ヶ月かかるようなシステム開発を数週間でカットオーバーできた、という事例@<fn>{note4}がたくさんあります。  
...
//image[gisyohaku10_catalog-article_G][開発者向けサイトと開発者ライセンスへのリンク][scale=0.8]

//footnote[kintone][kintone]

とは@<br>ITの知識がなくても自社の業務に合わせたアプリを作成でき、日々変化する業務にあわせた改良も簡単に素早くできる、ノーコード・ローコードツールです。主な機能として「データベース＋ワークフロー＋コミュニケーション」の特性があり、顧客管理、出張申請、業務日報など幅広い用途で活用できるため、現場主導の継続的な業務改善を実現します.
